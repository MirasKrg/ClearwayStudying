      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-8">
            ...
            <a href="/diary" onClick={(e) => handleNavClick(e, '/diary')} className="text-gray-600 dark:text-gray-300 hover:text-brand-primary dark:hover:text-brand-primary-light transition-colors">Дневник</a>
          </nav>
